  ...
  <div className="br-container">
    ...
    <div className="toolbar">
      ...
      <div className="toolbar-row">
        ...
        <button className="btn btn-primary" onClick={onCreate}>+ Нова брошура</button>
      </div>
    </div>
        ...
        <div className="table-wrap">
          <table className="table table-hover table-tight">
            ...
            <tbody>
              {rows.length === 0 && (
                <tr>
                  <td colSpan={9} className="center text-muted">Няма брошури.</td>
                </tr>
              )}
              {rows.map(r => (
                <tr key={r.brochure_id}>
                  ...
                  <td>
                    <div className="btn-row">
                      ...
                      <button className="btn btn-danger" onClick={() => onDelete(r)}>Изтрий</button>
                    </div>
                  </td>
                </tr>
              ))}
      ...
      <div className="br-preview-scroll">
        <table className="table table-tight">
          ...
          <tbody>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={1 + editions.length} className="center text-muted">Няма данни</td>
              </tr>
            )}
          </tbody>
        </table>
...
function Pagination({ page, totalPages, onPrev, onNext, onJump }) {
  ...
  return (
    <div className="pagination">
      <button className="page-btn" onClick={onPrev} disabled={page <= 1}>Предишна</button>
      {pages.map((p, i) =>
        p === "…" ? (
      ...
      <button className="page-btn" onClick={onNext} disabled={page >= totalPages}>Следваща</button>
    </div>
  );
}
